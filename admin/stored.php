...
<body>
    <div class="top">
        ...
        <nav class="menu">
            <ul>
                ...
                <a class="naav" href="stored.php"><button style="background-color: #00fdcf;color: black;">Store Details</button></a>
    ...
    <center>
        ...
        margin-left: -10px;background-color: #00fdcf">
            <h2 style="font-family: Poppins;font-size:30px;color:Black">Store Details</h2>
        </div>
        <br>
    </center>
...
?>
    ...
    <br><br>
    <center>
        <h3><span class="fancy">Register New Branch</span></h3>
        <div class="signup">
            <form action="custcmp1.php" method="POST">
                <table style="width:60%">
                    ...
                    <tr>
                        <td>City</td>
                        <td><input style="width:100%" type="text" name="city" required></td>
                    </tr>
                    <tr>
                        <td>Region</td>
                        <td><input style="width:100%" type="text" name="region" required></td>
                    </tr>
                    <tr>
                        <td>State</td>
                        <td><input style="width:100%" type="text" name="state" required></td>
                    </tr>
                    <tr>
                        <td>Pincode</td>
                        <td><input style="width:100%" type="text" name="pincode" required></td>
                    </tr>
                </table>
                <input type="submit" value="Register New Branch">
            </form>
