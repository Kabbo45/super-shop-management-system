...
<body>
    <div class="top">
        ...
        <nav class="menu">
            <ul>
                <a class="naav" href="dhome.php"><button style="background-color: #00fdcf;color: black;">Home</button></a>
    ...
    <div class="container">
        ...
        <b style="color:red;" class="wel">Admin ID: <span class="fancy"><a class="name"><?php echo $CustID; ?></a></span></b>
    </div>
</body>
